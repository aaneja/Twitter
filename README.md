# Project 3 - *Yet Another Twitter*

**Yet Another Twitter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
![YetAnotherTwitter](/YetAnotherTwitter-2.mp4.gif?raw=true "Yet another twitter app")
...
- [Glide](http://guides.codepath.com/android/Displaying-Images-with-the-Glide-Library) - Image loading and caching library for Android
